...
FOREIGN KEY (ARTIST_UNAME) REFERENCES [dbo].[USER] ON UPDATE CASCADE ON DELETE CASCADE 
)
...
FOREIGN KEY (EXPERT_UNAME) REFERENCES [dbo].[USER] ON UPDATE CASCADE ON DELETE CASCADE
)
...
PRIMARY KEY (AW_CODE),
FOREIGN KEY (CATEGORY_NAME) REFERENCES CATEGORY ON UPDATE CASCADE,
FOREIGN KEY (ARTIST_UNAME) REFERENCES ARTIST ON UPDATE CASCADE,
FOREIGN KEY (ADMIN_ID) REFERENCES [dbo].[ADMIN] ON UPDATE CASCADE
)
...
FOREIGN KEY ([USER_NAME]) REFERENCES [dbo].[USER] ON UPDATE CASCADE
)
...
FOREIGN KEY ([USER_NAME]) REFERENCES [dbo].[USER] ON UPDATE CASCADE,
FOREIGN KEY (ADMIN_ID) REFERENCES [dbo].[ADMIN] ON UPDATE CASCADE,
FOREIGN KEY (ORDER_ID) REFERENCES [dbo].[ORDER] ON UPDATE CASCADE
)
...
[USER_NAME] VARCHAR(20) NOT NULL ,
FOREIGN KEY ([USER_NAME]) REFERENCES [dbo].[USER] ON UPDATE CASCADE,
FOREIGN KEY (TITLE) REFERENCES [dbo].[EVENT] ON UPDATE CASCADE,
...
FOREIGN KEY (ORDER_ID) REFERENCES [dbo].[ORDER] ON UPDATE CASCADE,
FOREIGN KEY (ADMIN_ID) REFERENCES [dbo].[ADMIN] ON UPDATE CASCADE,
FOREIGN KEY (SHIPPING_NAME) REFERENCES SHIPPING_COMPANY ON UPDATE CASCADE,
FOREIGN KEY ([USER_NAME]) REFERENCES [dbo].[USER] ON UPDATE CASCADE,
...
FOREIGN KEY (NAME) REFERENCES CATEGORY ON UPDATE CASCADE,
FOREIGN KEY (SURVEY_ID) REFERENCES SURVEY ON UPDATE CASCADE
)
...
AW_CODE INT NOT NULL,
FOREIGN KEY (SURVEY_ID) REFERENCES SURVEY ON UPDATE CASCADE,
FOREIGN KEY (AW_CODE) REFERENCES ARTWORK ON UPDATE CASCADE,
...
FOREIGN KEY ([USER_NAME]) REFERENCES [USER] ON UPDATE CASCADE,
FOREIGN KEY (AW_CODE) REFERENCES ARTWORK,
...
FOREIGN KEY (EXPERT_UNAME) REFERENCES EXPERT ON UPDATE CASCADE,
